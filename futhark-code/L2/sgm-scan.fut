...
-- }
-- output {
--   [1i32, 3i32, 6i32, 4i32, 9i32, 15i32, 7i32]
-- }
--
-- compiled random input { [8388608]i32 } auto output
...
let main [n] (data: [n]i32) =
  let flags = map (\i -> if (i % 3) == 0 then true else false) (iota n)
